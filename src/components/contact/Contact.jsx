        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            <div className="contact__form-div">
              <label className="contact__form-tag">Name (ชื่อ)</label>
              <input
                type="text"
                name="name"
                className="contact__form-input"
                placeholder="Insert your name (กรุณาใส่ชื่อของคุณ)"
              />
            </div>

            <div className="contact__form-div">
              <label className="contact__form-tag">Mail (อีเมล)</label>
              <input
                type="email"
                name="email"
                className="contact__form-input"
                placeholder="Insert your email (กรุณาใส่อีเมลของคุณ)"
              />
            </div>

            <div className="contact__form-div contact__form-area">
              <label className="contact__form-tag">Message (ข้อความ)</label>
              <textarea
                name="message"
                cols="30"
                rows="10"
